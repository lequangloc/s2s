...
checkent[invalid] nll1(x1,x2,null) * x2::RefNLL_lvl2_t<next2 = x3,down = x2_1> * lso(x2_1,null) * nll1(x3,null,null) * nll(x4,x5,null) * x5::RefNLL_lvl2_t<next2 = x6,down = x1_2> * lso1(x1_2,null)
