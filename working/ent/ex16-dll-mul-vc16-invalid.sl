...
checkent[invalid] x_emp::RefDll_t<next = w_emp,prev = null> * dll1(w_emp,u_emp,x_emp,y_emp) * y_emp::RefDll_t<next = z_emp,prev = u_emp> * x2_emp::RefDll_t<next = w2_emp,prev = null> * dll(w2_emp,y2_emp,null,z2_emp) & x2_emp != w2_emp & x_emp != w_emp & x_emp != z_emp & y_emp != z_emp
