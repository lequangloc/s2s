...
checkent[valid]  ls(x5, x7) *
 x10::Sll_t<x4> * x6::Sll_t<x9> * x7::Sll_t<x3> * 
...
/*
checksat[unsat] ls(x5,x7) * x10::Sll_t<x4> * x6::Sll_t<x9> * x7::Sll_t<x3> * x3::Sll_t<x6> * x9::Sll_t<x4> * ls(x2,x4) * ls(x8,x10) * x1::Sll_t<x10> * x4::Sll_t<x10> .
*/