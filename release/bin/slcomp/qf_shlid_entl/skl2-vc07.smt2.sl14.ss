...
checkent skl2(x4,x5) * x5::RefSL2_t<n1 = x6,n2 = x7> * skl1(x7,x6) * x1::RefSL2_t<n1 = x1_1,n2 = x2> * x1_1::RefSL2_t<n1 = x1_2,n2 = null> * skl1(x1_2,x2) * x2::RefSL2_t<n1 = null,n2 = null>
         |- skl2(x1,null) * skl2(x4,x6).
