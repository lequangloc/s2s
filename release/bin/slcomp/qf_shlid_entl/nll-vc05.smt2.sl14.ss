...
checkent x1::RefNLL_lvl2_t<next2 = x2,down = x1_1> * x1_1::RefNLL_lvl1_t<next1 = x1_2> * x1_2::RefNLL_lvl1_t<next1 = x1_3> * x1_3::RefNLL_lvl1_t<next1 = null> * nll(x2,null,null)
         |- nll(x1,null,null).
