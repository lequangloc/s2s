...
checkent nll(x1,x2,null) * x2::RefNLL_lvl2_t<next2 = x3,down = x2_1> * lso(x2_1,null) * nll(x3,null,null) * nll(x4,x5,null) * x5::RefNLL_lvl2_t<next2 = x6,down = x1_2> * lso(x1_2,null)
         |- nll(x4,x6,null) * nll(x1,null,null).
