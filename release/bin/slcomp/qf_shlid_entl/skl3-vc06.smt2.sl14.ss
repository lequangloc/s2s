...
checkent skl3(x1,x2) * x2::RefSL3_t<n1 = x2_0_1,n2 = x2_1,n3 = x3> * skl1(x2_0_1,x2_1) * skl2(x2_1,x2_2) * x2_2::RefSL3_t<n1 = x2_2_1,n2 = x3,n3 = null> * skl1(x2_2_1,x2_2_2) * x2_2_2::RefSL3_t<n1 = x3,n2 = null,n3 = null> * x3::RefSL3_t<n1 = x3_0_1,n2 = x3_1,n3 = x4> * skl1(x3_0_1,x3_1) * skl2(x3_1,x4) * skl3(x4,null)
         |- skl3(x1,null).
