...
checkent skl1(Z1,Z2) * skl21(Z2,x3) * skl3(x4,x5) * x5::RefSL3_t<n1=x6,n2=Z1,n3=Z2> * x2::RefSL3_t<n1=x2_0_1,n2=x2_1,n3=x3> * skl11(x2_0_1,x2_1) * skl2(x2_1,x2_2) * x2_2::RefSL3_t<n1=x2_2_1,n2=x2_3,n3=null> * skl1(x2_2_1,x2_2_2) * x2_2_2::RefSL3_t<n1=x2_2_3,n2=null,n3=null> * x2_2_3::RefSL3_t<n1=x2_2_4,n2=null,n3=null> * skl1(x2_2_4,x2_3) * skl2(x2_3,x3) * skl3(x3,null)
    |- skl3(x2,null) * skl31(x4,x6).
