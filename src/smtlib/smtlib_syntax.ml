...
and attribute =
 | AttributeKeyword of pd * string 
 | AttributeKeywordValue of pd * string * attributevalue

and attributevalue =
  | AttributeValSpecConst of pd * specconstant
  | AttributeValSymbol of pd * symbol
  | AttributeValSexpr of pd * attributevalsexpr_attributevalue_sexpr5
...
and command =
 ...
 | CommandDefineSort of pd * symbol * commanddefinesort_command_symbol11 * sort
 | CommandDeclareFun of pd * symbol * commanddeclarefun_command_sort13 * sort
 | CommandDeclareVariable of pd * symbol * sort
 | CommandDefineFun of pd * symbol * commanddefinefun_command_sortedvar15 * sort * term
 ...
 | CommandGetValue of pd * commandgetvalue_command_term24
 | CommandGetAssign of pd
 | CommandGetModel of pd
 | CommandGetOption of pd * string
 | CommandGetInfo of pd * infoflag | CommandExit of pd

and commands = | Commands of pd * commands_commands_command30

and identifier =
  | IdSymbol of pd * symbol
  | IdUnderscoreSymNum of pd * symbol * idunderscoresymnum_identifier_numeral33
...
and sexpr =
  ...
  | SexprInParen of pd * sexprinparen_sexpr_sexpr41

and sort =
  | SortIdentifier of pd * identifier
  | SortIdSortMulti of pd * identifier * sortidsortmulti_sort_sort44
...
and term =
  ...
  | TermQualIdTerm of pd * qualidentifier * termqualidterm_term_term56
  | TermLetTerm of pd * termletterm_term_varbinding58 * term
  | TermForAllTerm of pd * termforallterm_term_sortedvar60 * term
  | TermExistsTerm of pd * termexiststerm_term_sortedvar62 * term
  | TermExclimationPt of pd * term * termexclimationpt_term_attribute64
...
and pd_command = function 
  ...
  | CommandDeclareVariable(d,_,_) -> d
