...
and pp_command = function 
  ...
  | CommandDeclareDataType (_,_,_) -> print_string "(CommandDeclareDataType)" ;()
  | CommandDeclareDataTypes (_,_,_) -> print_string "(CommandDeclareDataTypes)\n"; ()
  | CommandDeclareHeap (_,_) -> print_string "(CommandDeclareHeap)\n"; ()
  | CommandDefineFunRec _ -> print_string "(CommandDefineFunRec)\n"; ()
  | CommandCheckUnSat (_) ->  print_string "(";print_string " "; print_string "check-unsat";print_string " "; print_string ")"; () 
  | CommandDeclareConst (_ , symbol3 , sort7) ->  print_string "(";print_string " "; print_string "declare-const";print_string " "; pp_symbol symbol3;print_string " "; print_string " "; pp_sort sort7;print_string " "; print_string ")"; ()
...
and pp_index = function
  | Nindex (d, str1) -> print_string str1
  | Sindex (d, num) ->  pp_symbol num

and pp_idunderscoresymnum_identifier_numeral35 = function 
   |(_,[]) ->   () 
   | (d , (idx)::idunderscoresymnum_identifier_numeral352) ->  pp_index idx ;print_string " "; pp_idunderscoresymnum_identifier_numeral35 (d,idunderscoresymnum_identifier_numeral352); () 
